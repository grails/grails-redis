...
The @MemoizeSet annotation is to be used when dealing with set type objects.  This annotation takes the following parameters:
...
Here is an example of usage:
    ...
    @MemoizeSet(key = "mySet")
    def getAnnotatedSet(Set set) {
        println 'cache miss getAnnotatedSet'
        return set
    }
